...
-- Version for Cyclone 10 10CL010YE144C6G with more memory
...
port map(
   ...
   show  => boot_phase(0),    
	...
	bcd	=> bm_disp_bcd,
	-- input (display data)
	display1	=> ( x"F",x"F",x"F",x"7",x"1",x"4" ), -- RTH put sw version here
	-- Board-ID 7 seit 07.2026 (vorher 3, kollidierte mit 'WillFA7 - CycloneIV_v4').
	-- Funktionsstand (.14) unveraendert - diese Variante ruht, siehe VARIANTEN.md.
...
-- Soundboard
----------------
--wr_sbrom1 <= '1' when address_sd_card(14 downto 12) = "000" and wr_rom='1' else '0'; --first 4K
--wr_sbrom2 <= '1' when address_sd_card(14 downto 12) = "001" and wr_rom='1' else '0'; --sec 4K
--wr_sbrom3 <= '1' when address_sd_card(14 downto 12) = "010" and wr_rom='1' else '0'; -- third 4K
--wr_sbrom4 <= '1' when address_sd_card(14 downto 12) = "011" and wr_rom='1' else '0'; -- fourth 4K
--wr_sbrom5 <= '1' when address_sd_card(14 downto 12) = "100" and wr_rom='1' else '0'; -- fift 4K
wr_sbrom1 <= '1' when address_sd_card(13 downto 11) = "000" and wr_rom='1' else '0'; --first 4K
wr_sbrom2 <= '1' when address_sd_card(13 downto 11) = "001" and wr_rom='1' else '0'; --sec 4K
wr_sbrom3 <= '1' when address_sd_card(13 downto 11) = "010" and wr_rom='1' else '0'; -- third 4K
wr_sbrom4 <= '1' when address_sd_card(13 downto 11) = "011" and wr_rom='1' else '0'; -- fourth 4K
wr_sbrom5 <= '1' when address_sd_card(13 downto 11) = "100" and wr_rom='1' else '0'; -- fift 4K
...
port map(
		...
		option  => "0000", --game_option(1 to 4),
